...
export default function AddHospitalForm() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Direct Form (no background container) */}
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full bg-white/10 border border-white/20 rounded-2xl px-4 py-3 text-white placeholder-white/50 
                         focus:outline-none focus:ring-2 focus:ring-white/40 transition-all backdrop-blur-lg"
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-white/10 border border-white/20 rounded-2xl px-4 py-3 text-white 
                         focus:outline-none focus:ring-2 focus:ring-white/40 cursor-pointer transition-all backdrop-blur-lg"
            >
        ...
        <div>
          ...
          <div className="h-48 bg-white/5 border border-white/20 rounded-2xl flex items-center justify-center 
                          backdrop-blur-lg hover:scale-[1.01] transition-all">
        ...
        <div>
          ...
          <div className="border-2 border-dashed border-white/20 rounded-2xl p-8 text-center 
                          hover:border-white/40 hover:scale-[1.01] backdrop-blur-lg transition-all cursor-pointer">
        ...
        <div className="flex items-center space-x-4 pt-6">
          <button
            type="submit"
            disabled={loading}
            className="flex items-center space-x-2 px-6 py-3 bg-white/80 text-[#023e8a] rounded-2xl 
          ...
          <button
            type="button"
            className="px-6 py-3 bg-white/10 text-white rounded-2xl font-medium 
