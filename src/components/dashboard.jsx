          ...
          return (
            <button
              ...
              onClick={() => {
                ...
                if (stat.title === "Total Patients") setCurrentPage("users")
                if (stat.title === "Verified Hospitals") setCurrentPage("hospitals")
                if (stat.title === "Emergency Reports") setCurrentPage("emergencies")
                if (stat.title === "Active Doctors") setCurrentPage("users")
              }}
              className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 md:p-6 hover:bg-white/10 transition-all duration-300 hover:scale-105 text-left group cursor-pointer"
            >
